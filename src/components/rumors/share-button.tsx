...
export function ShareButton({ rumor }: ShareButtonProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <Button onClick={handleShareX} variant="outline" size="sm" className="gap-2">
        <svg
          viewBox="0 0 24 24"
      ...
      <Button onClick={handleShareWhatsApp} variant="outline" size="sm" className="gap-2 text-green-400 border-green-400/30 hover:bg-green-400/10">
